        ...
        gsap.to("#next-video",{
            ...
            onStart: () => {
                if (nextVideoRef.current) {
                    nextVideoRef.current.play(); // Make sure this runs only if the ref exists
                }
            },
        })
        ...
        <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden bg-blue-75 rounded-lg">
                <div>
                    <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg
                                    scale-50 opacity-0 transition-all duration-500 hover:scale-100 hover:opacity-100"
                ...
                <div className="absolute left-0 top-0 z-40 size-full">
                    <div className="mt-24 p-5 sm:p-10">
                        <h1 className="special-font hero-heading text-blue-100">rededfi<b>n</b>e</h1>
                        <p className="font-robert-regualr mb-5 text-blue-100 max-w-64">
